...
namespace CarBookProject.Application.Tools
{
	public class JwtTokenGenerator
	{
		public static TokenResponseDto GenerateToken(GetCheckAppUserQueryResult result)
		{
			...
			JwtSecurityToken token = new JwtSecurityToken(issuer: JwtTokenDefaults.ValidIssuer, JwtTokenDefaults.ValidAudiance, claims, notBefore: DateTime.UtcNow, expires: expireDate, signingCredentials: signinCredentials);
